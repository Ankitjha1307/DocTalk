...
const Header = ({ isChatbotOpen, onChatbotToggle }) => {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [isProfileOpen, setIsProfileOpen] = useState(false);
  const [isChatbotModalOpen, setIsChatbotModalOpen] = useState(false); // Separate state for modal
 ...
 const handleOpenFullChatbot = () => {
    onChatbotToggle(true); // Use the prop function
  };
...
/>
      ...
      {/* ChatBot Component */}
      <ChatBot isOpen={isChatbotModalOpen} onClose={() => setIsChatbotModalOpen(false)} />
    </>
  );
};
